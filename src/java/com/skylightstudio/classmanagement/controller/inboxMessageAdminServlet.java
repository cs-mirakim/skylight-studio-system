...
public class inboxMessageAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // ✅ NEW: Check if request is from JSP page (not AJAX)
        if (action == null) {
            // Forward to JSP page for normal page load
            try {
                ...
                request.setAttribute("unreadCount", countUnreadNotifications());

                request.getRequestDispatcher("/admin/inboxMessages_admin.jsp").forward(request, response);
                return;
        ...
        // ✅ EXISTING: Handle AJAX requests (JSON response)
